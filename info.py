...
BOT_TOKEN = environ.get('BOT_TOKEN', "7630927324:AAEFQcKPyAmaGuh6w221_3Rbw4aHAT78JPQ")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002663725977').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://hmerepass:hmerepass@cluster0.i1zcu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
